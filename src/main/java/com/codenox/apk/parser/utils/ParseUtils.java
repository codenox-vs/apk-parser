...
import com.codenox.apk.parser.parser.StringPoolEntry;
import com.codenox.apk.parser.struct.ResValue;
	...
	public static void checkChunkType(int expected, int real) {
		if(expected != real) {
			throw new ParserException(
				"Expect chunk type:" + Integer.toHexString(expected) + ", but got:" + Integer.toHexString(real));
		}
	}
